  ...
  return (
    <div className="fade-in">
      <div style={{marginBottom:24}}>
        <button onClick={()=>navigate('/staff')} className="btn btn-outline btn-sm">← Staff Directory</button>
      </div>
      <div style={{display:'flex',alignItems:'center',gap:20,padding:'24px 28px',background:'var(--surface)',borderRadius:16,border:'1px solid var(--border)',marginBottom:24}}>
      ...
      <div style={{maxWidth:680}}>
        ...
        {tab==='bank'&&isAdmin&&(
          <div className="card card-pad">
            <div style={{padding:'10px 14px',background:'var(--amber-soft)',border:'1px solid var(--amber)',borderRadius:7,fontSize:13,color:'var(--amber)',marginBottom:16}}>
