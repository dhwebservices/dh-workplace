        ...
        <div className="card" style={{ overflow: 'hidden' }}>
          ...
          : staff.map(member => (
            <button key={member.id} onClick={() => setSelected(member)}
              style={{ width: '100%', padding: '14px 16px', border: 'none', borderBottom: '1px solid var(--border)', background: selected?.id === member.id ? 'var(--bg)' : 'transparent', cursor: 'pointer', textAlign: 'left', transition: 'background 0.15s' }}>
